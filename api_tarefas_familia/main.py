...
from app.routers import local, tarefa, usuario, tarefa_usuario, category, tarefa_email, tarefa_conclusao_diaria
...
app.include_router(tarefa_conclusao_diaria.router)
